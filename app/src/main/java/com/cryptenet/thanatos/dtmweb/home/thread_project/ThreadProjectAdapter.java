...
public class ThreadProjectAdapter extends ArrayAdapter<ThreadIdentity> {
    private Context context;
    private List<ThreadIdentity> projects;
    private int count = 0;
//    private ItemClickListener itemClickListener;

    public ThreadProjectAdapter(@NonNull Context context, List<ThreadIdentity> projects) {
        super(context, R.layout.node_thread_project, projects);
...
//                itemClickListener.onItemClick(position);
                ...
                EventBus.getDefault().post(new InitiatorThreadsEvent(projects.get(position).getPlan()));
