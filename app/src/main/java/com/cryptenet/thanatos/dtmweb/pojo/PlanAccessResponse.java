...
public class PlanAccessResponse implements Parcelable {
    ...
    public final static Parcelable.Creator<PlanAccessResponse> CREATOR = new Creator<PlanAccessResponse>() {
        ...
        public PlanAccessResponse createFromParcel(Parcel in) {
            return new PlanAccessResponse(in);
        }
    ...
    protected PlanAccessResponse(Parcel in) {
        ...
        in.readList(this.results, (com.cryptenet.thanatos.dtmweb.pojo.Plans.class.getClassLoader()));
    }
     ...
     * @param next
     */
    public PlanAccessResponse(Integer count, Object next, Object previous, List<Plans> results) {
        super();
        this.count = count;
        this.next = next;
    ...
    public void setResults(List<Plans> results) {
        this.results = results;
    }
