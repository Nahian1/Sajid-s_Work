...
public class TransactionDetails implements Parcelable {
     ...
     */
    public TransactionDetails(Integer id, Integer plan, Integer investor, String planTitle, String bankName, String bankAccountName, String bankAccountNumber, String transactionId, String note, Boolean isApproved, String createdAt, Double planAccessPrice) {
        super();
        this.id = id;
        this.plan = plan;
