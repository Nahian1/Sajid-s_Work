...
public class ThreadInitResponse implements Parcelable
{
    ...
    public final static Creator<ThreadInitResponse> CREATOR = new Creator<ThreadInitResponse>() {
        ...
        public ThreadInitResponse createFromParcel(Parcel in) {
            return new ThreadInitResponse(in);
        }
    ...
    protected ThreadInitResponse(Parcel in) {
        ...
        this.lastActive = ((Object) in.readValue((Object.class.getClassLoader())));
        this.lastText = ((Object) in.readValue((Object.class.getClassLoader())));
     ...
     */
    public ThreadInitResponse(Integer id, Integer plan, Integer investor, Integer initiator, Boolean activated, Object lastActive, Object lastText, String planTitle, String planCover, String createdAt, String investorName, String investorPicture, String initiatorName, String initiatorPicture) {
        super();
        this.id = id;
        this.plan = plan;
    ...
    public void setLastText(Object lastText) {
        this.lastText = lastText;
    }
