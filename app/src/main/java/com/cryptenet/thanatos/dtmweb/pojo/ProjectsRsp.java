...
public class ProjectsRsp implements Parcelable
{
    ...
    public final static Creator<ProjectsRsp> CREATOR = new Creator<ProjectsRsp>() {
        ...
        public ProjectsRsp createFromParcel(Parcel in) {
            return new ProjectsRsp(in);
        }
     ...
     */
    public ProjectsRsp(Integer id, Integer initiator, String initiatorsName, String title, Integer category, String shortDescription, String longDescription, String minimumInvestmentCost, String maximumInvestmentCost, String initiatorAddress, String initiatorImage, String accessPrice, String cover, String uploadedFile, String createdAt, String coverThumbnail, Boolean isApproved) {
        super();
        this.id = id;
