...
public class ProjectsD implements Parcelable
{
    ...
    public final static Creator<ProjectsD> CREATOR = new Creator<ProjectsD>() {


        @SuppressWarnings({
            "unchecked"
        })
        public ProjectsD createFromParcel(Parcel in) {
            return new ProjectsD(in);
        }

        public ProjectsD[] newArray(int size) {
            return (new ProjectsD[size]);
        }

    }
    ;

    protected ProjectsD(Parcel in) {
     ...
     */
    public ProjectsD(Integer id, Integer initiator, String initiatorsName, String title, Integer category, String shortDescription, String longDescription, String minimumInvestmentCost, String maximumInvestmentCost, String initiatorAddress, String initiatorImage, String accessPrice, String cover, String uploadedFile, String createdAt, String coverThumbnail, Boolean isApproved) {
        super();
        this.id = id;
